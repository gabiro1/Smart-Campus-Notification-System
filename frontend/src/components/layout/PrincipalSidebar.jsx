...
const sections = [
  ...
  },
  {
    label: "Governance",
    items: [
      { path: "/principal/approvals", label: "Announcement Approvals", icon: ShieldAlert },
      { path: "/principal/role-assignments", label: "Role Approvals", icon: UserCheck },
      { path: "/principal/student-leadership", label: "Student Leadership", icon: Vote },
  ...
  },
  {
    label: "Events",
    items: [
      { path: "/principal/my-events", label: "Events", icon: LayoutDashboard },
    ],
  },
];
