...
export default function Login() {
  ...
  const validate = () => {
    ...
    if (!val) return "Enter your registration number or email";
              ...
              <div className="relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="relative group">
                    ...
                    <button
                      type="button"
                      onClick={() => setIsRegNumber(!isRegNumber)}
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-[10px] text-muted-foreground hover:text-blue-500 transition-colors px-2 py-1 rounded-md bg-accent"
                    >
                      {isRegNumber ? "Email" : "Reg No."}
                    </button>
                  </div>
                  ...
                  {/* Hidden contine with google and create an account */}
                  {false && (
                    <>
                      ...
                      <button
                        ...
                        onClick={async () => {
                          try {
                            ...
                            const data = await authService.firebaseGoogleAuth(idToken);
                            if (data?.success) {
