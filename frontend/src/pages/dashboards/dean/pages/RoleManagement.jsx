                      ...
                      className={`px-2.5 py-1 text-xs font-medium rounded-md border ${
                        user.role === "Head of Dept"
                          ...
                          : user.role === "Admin Staff"
                            ...
                            : "bg-accent text-neutral-300 border-border"
                      }`}
                    >
                      {user.role}
                    </span>
                  ...
                  <td className="p-5 text-right">
                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="p-1.5 text-muted-foreground hover:text-blue-400 bg-accent hover:bg-blue-500/10 rounded-md transition-all"
                        title="Edit Role"
                      >
                        <Edit2 size={16} />
                      </button>
                      <button
                        ...
                        className={`p-1.5 bg-accent rounded-md transition-all ${user.status === "Active" ? "text-muted-foreground hover:text-rose-400 hover:bg-rose-500/10" : "text-emerald-400 hover:text-emerald-300 hover:bg-emerald-500/10"}`}
                        title={
        ...
        {editingUser && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative w-full max-w-sm bg-background border border-border rounded-2xl p-6 shadow-2xl z-10"
            >
