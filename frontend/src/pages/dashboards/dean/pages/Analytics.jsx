    ...
    <div className="space-y-6">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-4 py-2 bg-black/40 border border-border rounded-xl text-sm text-neutral-300 hover:text-foreground transition-colors">
