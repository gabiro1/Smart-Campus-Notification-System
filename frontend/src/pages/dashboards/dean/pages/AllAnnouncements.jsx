      ...
      <GlassCard className="p-0 overflow-hidden flex flex-col min-h-[600px]">
        ...
        <div className="p-4 md:p-5 border-b border-border bg-white/[0.01] grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
          ...
          <div className="md:col-span-3">
            <div className="relative">
              ...
              <select
                ...
                className="w-full bg-black/40 border border-border rounded-xl pl-9 pr-4 py-2.5 text-sm text-neutral-300 focus:outline-none focus:border-blue-500/50 appearance-none"
              >
          ...
          <div className="md:col-span-4 flex justify-end gap-3">
            <button className="flex items-center gap-2 p-2.5 bg-accent border border-border rounded-xl text-muted-foreground hover:text-foreground hover:bg-white/10 transition-colors">
              <CalendarDays size={18} />
            </button>
            <button className="flex items-center gap-2 px-4 py-2.5 bg-accent border border-border rounded-xl text-neutral-300 hover:text-foreground hover:bg-white/10 transition-colors text-sm font-medium">
                ...
                >
                  ...
                  <td className="p-5 text-right">
                    <button
                      ...
                      className="p-2 text-muted-foreground hover:text-foreground bg-accent hover:bg-white/10 rounded-lg transition-all opacity-0 group-hover:opacity-100"
                    >
                      <Eye size={16} />
                    </button>
                  </td>
        ...
        {selectedAnnouncement && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: 20 }}
              className="relative w-full max-w-2xl bg-background border border-border rounded-2xl p-8 shadow-2xl z-10"
            >
              <h2 className="text-2xl font-bold text-foreground mb-2">
                {selectedAnnouncement.title}
              </h2>
              <div className="flex flex-wrap gap-4 text-sm text-muted-foreground border-b border-border pb-4 mb-6">
                <span>
              ...
              <div className="text-sm text-neutral-300 leading-relaxed mb-8 bg-white/[0.02] border border-border p-6 rounded-xl min-h-[150px]">
