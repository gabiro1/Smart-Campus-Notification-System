...
import RegistrarSidebar from "@/components/shared/RegistrarSidebar";
import RegistrarTopbar from "./RegistrarTopbar";
...
export default function RegistrarLayout() {
  ...
  return (
    <div className="min-h-screen bg-background relative">
      ...
      <div className="fixed bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-teal-900/10 rounded-full blur-[150px] pointer-events-none" />
