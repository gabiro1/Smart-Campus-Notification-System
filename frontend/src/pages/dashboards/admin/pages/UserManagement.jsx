...
const ROLES = [
  { value: "student", label: "Student", color: "text-blue-400", bg: "bg-blue-500/15" },
  { value: "lecturer", label: "Lecturer", color: "text-green-400", bg: "bg-green-500/15" },
  { value: "hod", label: "Head of Dept", color: "text-purple-400", bg: "bg-purple-500/15" },
  { value: "dean", label: "Dean", color: "text-amber-400", bg: "bg-amber-500/15" },
  { value: "principal", label: "Principal", color: "text-cyan-400", bg: "bg-cyan-500/15" },
  { value: "admin", label: "System Admin", color: "text-red-400", bg: "bg-red-500/15" },
  { value: "guild_president", label: "Guild President", color: "text-pink-400", bg: "bg-pink-500/15" },
];
