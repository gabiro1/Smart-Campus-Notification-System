      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute right-0 top-full mt-3 w-[380px] bg-background/95 backdrop-blur-xl border border-white/10 rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-50 overflow-hidden"
          >
            {/* Header */}
            <div className="p-5 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
              ...
              <div className="flex items-center gap-2">
                ...
                <button 
                  onClick={onClose}
                  className="p-1.5 hover:bg-white/5 rounded-full text-neutral-500 transition-colors"
                >
                  <X size={14} />
                </button>
              </div>
            ...
            <div className="max-h-[420px] overflow-y-auto custom-scrollbar">
              {notifications.length === 0 ? (
                <div className="py-20 flex flex-col items-center justify-center text-center px-10">
                  <div className="w-16 h-16 bg-white/[0.02] border border-white/5 rounded-2xl flex items-center justify-center mb-4 text-neutral-700">
                ...
                <div className="divide-y divide-white/5">
                  {notifications.map((notif) => (
                    <button
                      ...
                      className={`w-full text-left p-5 hover:bg-white/[0.03] transition-all flex gap-4 relative group ${
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-start mb-1">
                          <h4 className="text-xs font-bold text-white truncate pr-4 group-hover:text-blue-400 transition-colors uppercase tracking-tight">
                            {notif.title}
                          </h4>
                          <span className="text-[9px] font-bold text-neutral-600 whitespace-nowrap flex items-center gap-1">
                            <Clock size={8} />
                        ...
                        <div className="mt-2 flex items-center gap-3">
                           ...
                           <div className="ml-auto flex items-center gap-1 text-[9px] font-bold text-neutral-600 group-hover:text-blue-500 transition-colors">
            ...
            {notifications.length > 0 && (
              <button 
                ...
                className="w-full py-4 text-[10px] font-black text-neutral-500 hover:text-white uppercase tracking-[0.2em] bg-white/[0.01] border-t border-white/5 transition-all"
              >
