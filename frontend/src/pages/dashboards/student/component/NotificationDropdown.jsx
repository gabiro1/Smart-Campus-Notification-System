      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="absolute right-0 top-full mt-3 w-[380px] bg-[#111111]/95 backdrop-blur-xl border border-white/10 rounded-[24px] shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-50 overflow-hidden"
          >
            {/* Header */}
