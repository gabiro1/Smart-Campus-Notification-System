...
const LiquidToggle = ({ enabled, onChange }) => (
  <button
    ...
    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-all duration-300 focus:outline-none ${enabled ? "bg-emerald-600 shadow-[0_0_12px_rgba(16,185,129,0.5)]" : "bg-black/50 border border-border"}`}
  >
    <span
          ...
          <AnimatePresence mode="wait">
            ...
            >
                  ...
                  <GlassCard className="space-y-6">
                    ...
                    <div className="space-y-6">
                      <div className="flex items-center justify-between group">
                        <div className="pr-8">
                          <p className="text-foreground font-bold text-sm group-hover:text-emerald-100 transition-colors">
                            Auto-Categorization
                          </p>
              ...
              <div className="flex justify-end pt-4 gap-3">
                ...
                <button className="bg-emerald-600 hover:bg-emerald-500 text-foreground px-6 py-2.5 rounded-xl text-sm font-bold transition-all shadow-[0_0_15px_rgba(16,185,129,0.3)] flex items-center gap-2 active:scale-95">
