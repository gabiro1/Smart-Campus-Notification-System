...
function SidebarLink({ item, active }) {
  return (
    <Link
      to={item.path}
      className={`flex items-center justify-center md:justify-start p-3 md:p-2.5 rounded-sm transition-all duration-300 relative group overflow-hidden ${
        active
          ? "bg-white/[0.03] text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.1)] border border-white/10 "
