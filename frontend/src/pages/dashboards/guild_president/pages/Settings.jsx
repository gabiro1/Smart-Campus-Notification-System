  ...
  return (
    <div className="p-4 lg:p-6 w-full text-foreground">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">Manage your guild president account and preferences</p>
      </motion.div>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="flex-1 space-y-6">
          {activeTab === "account" && (
            ...
            >
              <GlassCard className="p-6">
                <h2 className="text-lg font-semibold text-foreground mb-6">Guild President Account</h2>
                <div className="space-y-6">
                  <div className="flex items-center gap-4 md:gap-6 p-4 bg-accent/50 rounded-xl">
                    ...
                    <div className="min-w-0">
                      <h3 className="text-lg md:text-xl font-semibold text-foreground truncate">{user?.name || "Guild President"}</h3>
                      <p className="text-sm text-muted-foreground">Guild President</p>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-accent/50 rounded-xl">
                    ...
                    <button
                      ...
                      className={`w-14 h-8 rounded-full transition-colors ${
                        settings.pushNotifications ? "bg-emerald-600" : "bg-accent"
                      }`}
                    >
                  ...
                  <div className="flex items-center justify-between p-4 bg-accent/50 rounded-xl">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Receive email updates for important guild matters</p>
                    </div>
                    <button
                  ...
                  <div className="flex items-center justify-between p-4 bg-accent/50 rounded-xl">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Get reminded about upcoming guild events</p>
                    </div>
                    <button
                      onClick={() => handleToggle("eventReminders")}
                      className={`w-14 h-8 rounded-full transition-colors ${
                        settings.eventReminders ? "bg-emerald-600" : "bg-accent"
                      }`}
                    >
                      <div className={`w-6 h-6 rounded-full bg-white shadow-lg transition-transform ${
                  ...
                  <div className="flex items-center justify-between p-4 bg-accent/50 rounded-xl">
                    ...
                    <button
                      ...
                      className={`w-14 h-8 rounded-full transition-colors ${
                        settings.announcementAlerts ? "bg-emerald-600" : "bg-accent"
                      }`}
                    >
                      <div className={`w-6 h-6 rounded-full bg-white shadow-lg transition-transform ${
                  ...
                  <div className="flex items-center justify-between p-4 bg-accent/50 rounded-xl">
                    <div>
                      <h4 className="font-medium text-foreground">Class Rep Updates</h4>
                      <p className="text-sm text-muted-foreground">Get notified when class reps are approved or rejected</p>
                    </div>
                    <button
                      onClick={() => handleToggle("classRepUpdates")}
                      className={`w-14 h-8 rounded-full transition-colors ${
                        settings.classRepUpdates ? "bg-emerald-600" : "bg-accent"
                      }`}
                    >
                      <div className={`w-6 h-6 rounded-full bg-white shadow-lg transition-transform ${
                        settings.classRepUpdates ? "translate-x-7" : "translate-x-1"
                      }`} />
                    </button>
                  </div>
                </div>
            ...
            >
              <GlassCard className="p-6">
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Choose up to <span className="text-foreground font-medium">3 interests</span> to personalize your event feed. The AI engine ranks events higher when they match your interests.
                </p>
                ...
                <div className="mb-6 p-4 bg-accent/50 rounded-xl">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="e.g., Student Welfare, Campus Issues..."
                      className="flex-1 bg-background border border-border rounded-xl px-4 py-2.5 text-sm text-foreground outline-none focus:border-emerald-500/50 transition-colors placeholder:text-muted-foreground"
                    />
                    <button
                      type="button"
                      onClick={addCustomInterest}
                      disabled={!customInterest.trim() || selectedInterests.length >= 3}
                      className="px-4 py-2.5 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed text-white rounded-xl font-medium transition-colors flex items-center gap-1.5"
                    >
                      <Plus size={16} /> Add
                    </button>
                  </div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {selectedInterests.map((interest) => {
                        ...
                        return (
                          ...
                          >
                            {predefined && <predefined.icon size={14} className="text-emerald-400" />}
                ...
                <div className="flex items-center justify-between p-4 bg-accent/50 rounded-xl">
                  ...
                  <Heart size={20} className={selectedInterests.length > 0 ? "text-emerald-500" : "text-muted-foreground"} />
                </div>
              </GlassCard>
            </motion.div>
          )}
          ...
          {activeTab === "preferences" && (
            ...
            >
              <GlassCard className="p-6">
                <h2 className="text-lg font-semibold text-foreground mb-6">Guild Preferences</h2>
                <div className="space-y-6">
                  <div className="flex items-center justify-between p-4 bg-accent/50 rounded-xl">
