        ...
        <GlassCard className="lg:col-span-1 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <textarea
                rows="2"
                className="w-full bg-background/50 border border-border rounded-xl px-4 py-3 text-foreground focus:outline-none focus:border-blue-500/50 resize-none"
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                className="w-full bg-background/50 border border-border rounded-lg px-4 py-2 text-sm text-foreground focus:outline-none focus:border-blue-500/50"
              />
              <input
                type="text"
            ...
            <button className="w-full bg-accent hover:bg-accent/80 border border-border text-foreground font-medium py-2 rounded-xl transition-all">
              + Add Option
            </button>
            <button className="w-full bg-blue-600 hover:bg-blue-500 text-foreground font-semibold py-2.5 rounded-xl transition-all shadow-[0_0_15px_rgba(59,130,246,0.3)] mt-4">
              Launch Poll
            </button>
          </div>
        </GlassCard>
