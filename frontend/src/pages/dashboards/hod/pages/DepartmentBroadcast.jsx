        ...
        <GlassCard className="lg:col-span-7 space-y-6 mx-auto w-full">
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full bg-black/40 border border-border rounded-xl px-4 py-3 text-foreground focus:outline-none focus:border-blue-500/50 transition-all placeholder:text-muted-foreground"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full bg-black/40 border border-border rounded-xl px-4 py-3 text-foreground focus:outline-none focus:border-blue-500/50 transition-all placeholder:text-muted-foreground resize-none"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select 
                  ...
                  className="w-full bg-black/40 border border-border rounded-xl px-4 py-3 text-foreground focus:outline-none focus:border-blue-500/50 appearance-none"
                >
            ...
            <div>
              ...
              <button className="w-full py-4 border-2 border-dashed border-border hover:border-blue-500/30 bg-accent hover:bg-accent rounded-xl flex flex-col items-center justify-center gap-2 text-muted-foreground hover:text-blue-400 transition-all">
                <UploadCloud size={24} />
          ...
          <div className="pt-6 border-t border-border flex justify-end">
            <button 
              ...
              disabled={loading}
              className="bg-blue-600 hover:bg-blue-500 text-foreground px-8 py-3 rounded-xl text-sm font-semibold transition-all shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_25px_rgba(59,130,246,0.5)] flex items-center gap-2 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
            >
        ...
        <div className="lg:col-span-5 space-y-4 mx-auto w-full">
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-5 relative z-10">
              <div className="w-10 h-10 rounded-full bg-card border border-border flex items-center justify-center text-rose-400 font-bold">
                HoD
              </div>
              <div>
            ...
            <h2 className="text-xl font-bold text-foreground mb-3 relative z-10">
              {title || "Your broadcast title..."}
            </h2>
            <p className="text-sm text-foreground leading-relaxed mb-6 relative z-10 break-words whitespace-pre-wrap">
              {message ||
                "The body of your official broadcast will appear here exactly as students will see it on their mobile app or web portal."}
            </p>

            <div className="flex items-center gap-2 text-xs text-muted-foreground bg-black/40 p-2.5 rounded-lg w-fit border border-border relative z-10">
