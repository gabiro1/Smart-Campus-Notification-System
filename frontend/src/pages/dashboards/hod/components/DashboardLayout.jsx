...
import Sidebar from "@/components/shared/HODSidebar";
...
export default function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-background text-white flex overflow-hidden selection:bg-blue-500/30">
      ...
      <div className="flex-1 flex flex-col md:ml-64 relative z-10 h-screen overflow-hidden">
        {/* Mobile Header */}
        <div className="md:hidden flex items-center justify-between p-4 border-b border-white/5 bg-background/80 backdrop-blur-md">
